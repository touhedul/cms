        ...
        <div class="breadcrumb-wrapper col-12" style="padding-bottom: 15px">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="/admin/blog">Posts list</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="/admin/add-blog-post">Add post</a>
                </li>
            </ol>
        </div>
    </div>
...
<div id="cms-module">
    <posts-create :editable_post="{{(isset($editable_post)) ? json_encode($editable_post) :  'null'}}"></posts-create>
</div>
@endsection
